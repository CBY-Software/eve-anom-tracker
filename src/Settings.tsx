    ...
    <div className="flex-1 overflow-y-auto pr-2 pb-8 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <button
          ...
          className="w-full py-3 bg-red-500/10 border border-red-500/50 text-red-500 font-bold text-xs uppercase tracking-[0.2em] rounded hover:bg-red-500 hover:text-[#0a0a0a] transition-all duration-200 flex items-center justify-center space-x-2 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
        >
          {isRestoring ? (
            <>
              <Loader2 size={16} className="animate-spin" />
